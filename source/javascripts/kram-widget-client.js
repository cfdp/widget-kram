// Resize iframe script is based on https://github.com/lajlev/iframe_height
(function() {
  ...
  ie = (navigator.userAgent.toLowerCase().indexOf('msie') > -1) && !(navigator.userAgent.toLowerCase().indexOf('msie 10') > -1) && !(navigator.userAgent.toLowerCase().indexOf('msie 9') > -1),
...
window.onload = function() {
  IframeResize.load({
    // FIX THIS
    src : 'http://kram-widget.cfdp.dk/index.html',
    domain : 'http://kram-widget.cfdp.dk',
    element : 'kram-widget'
    // src : 'http://fe50e45.fjords.cc/index.html',
    // domain : 'http://fe50e45.fjords.cc',
    // element : 'kram-widget'
  })
}